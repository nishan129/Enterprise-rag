...
def planner_node(state: AgentState):
    """
    The Planner determines if a search is needed based on the ENTIRE conversation history and the current question. It should not have access to any retrieved documents or external information. It should only analyze the conversation and question to make its decision.
    """
