...
#  - Fallback: primary @rag/llama-3.3-70b-versatile -> @brag/llama-3.1.8b-instant 
#  - Chache: semantic mode 

GATEWAY_CONFIG = {
    "stratgy": {"mode":"fallback"},
    "cache":{"mode":"semantic"},
    "retry":{
        "attempts":2,
...
def get_langchain_llm(feature:str = 'rag') -> ChatOpenAI:
    """
    Returns a Portkey-backed ChatOpenAI - a drop-in for ChatGroq in langchains Nodes
